...
var WebConfig = /** @class */ (function () {
        ...
        var viewport = {
            ...
            "options": {
                "timeseries": (this.config.defaultPlotOptions !== undefined ?
                    cloneDeep(this.config.defaultPlotOptions["timeseries"] || {}) : {})
            },
            "metrics": [],
            "categories": {
                "name": "geo" // or "metric" ???
    ...
    WebConfig.prototype.getValidMetricTypes_ = function (viewport, metric) {
        ...
        // new
        if (isEmpty(this.config.plotTypes[viewport.plotType]) ||
            isEmpty(this.config.plotTypes[viewport.plotType].metricUsage)) {
        ...
        metricTypes.forEach(function (mt) {
            if (!isEmpty(metricSpec.querySpecs[mt])) {
                metricTypeArr.push(mt);
            }
        });
        if (isEmpty(metricTypeArr)) { // shouldn't happen
    ...
    WebConfig.prototype.isGeoFieldEmpty = function (field) {
        return isEmpty(field) || field === 'none';
    };
...
export { AnnotatedWebConfig, aggregateTimeseries, annotatedWebConfig, getLabel$1 as getLabel, globalConfig };
